  ...
  return (
    <>
      ...
      <aside className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-56 lg:flex-col">
        <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-slate-900 px-4 py-6">
          <Link href="/companies" className="flex items-center gap-2 px-2">
            ...
            <span className="text-lg font-semibold text-white">SignalKit</span>
          </Link>
      ...
      {/* Mobile top bar */}
      <div className="sticky top-0 z-40 flex items-center gap-4 border-b border-slate-200 bg-slate-900 px-4 py-3 lg:hidden">
        <Link href="/companies" className="flex items-center gap-2">
          ...
          <span className="text-base font-semibold text-white">SignalKit</span>
        </Link>
